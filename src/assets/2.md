...
I'm a long time user and fan of PD. I started on it because I couldn't afford [Max/MSP](Max/MSP) back then (around 2004). I have a lot to thank it for. I'll do some digging into the WebPD implementation of Pure Data and collect the results in this log.
